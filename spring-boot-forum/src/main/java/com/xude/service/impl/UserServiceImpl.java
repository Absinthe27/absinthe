...
import com.xude.event.OnRegistrationCompleteEvent;
...
import com.xude.persistence.dao.VerificationTokenMapper;
...
import com.xude.service.StorageService;
...
public class UserServiceImpl implements UserService {
	...
	public Map<String, Object> updateUserProfile(UserSettingsDto userSettingsDto) {
		...
		user.setNickname(userSettingsDto.getNickname());
	...
	public Map<String, Object> getUserSettingPage() {
		...
		newUserSettingsForm.setNickname(user.getNickname());
		Map<String, Object> attributes = new HashMap<>();
		attributes.put("user", user);
		attributes.put("userSettingsDto", newUserSettingsForm);


		List<Post> postsByUserId = postMapper.findPostsByUserId(user.getId());
		attributes.put("posts",postsByUserId);
		return attributes;
	}
	...
	public Map<String, Object> registerUserAccount(UserRegistrationDto userDto, HttpServletRequest request) {
		...
		user.setAvatarLocation("images/avatar/xude/zz.png");
		...
		//user.setAvatarLocation("avatar/default_avatar.png");
